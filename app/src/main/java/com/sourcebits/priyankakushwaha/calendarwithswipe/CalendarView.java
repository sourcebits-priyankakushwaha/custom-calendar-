package com.sourcebits.priyankakushwaha.calendarwithswipe;
...
public class CalendarView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final LinearLayout calendarLayout = (LinearLayout) inflater.inflate(R.layout.calendar, null);
        ...
        currentMonth = (TextView) calendarLayout.findViewById(R.id.calendar_date_display);
